...
public sealed class LearningReviewStatusEventAdapter
{
    public OperationResult<LearningCommandResult> Execute(string tenantId = "school-1", string actorReference = "actor-1", string sourceReference = "demo")
    {
        ...
        return OperationResult<LearningCommandResult>.Success(new LearningCommandResult("learningreviewstatuseventadapter", [new LearningTraceReference("learning", sourceReference, tenantId, actorReference)]));
    }
}
