...
- [ ] T018 Create Phase 4 capability constants for wallet.ledger, wallet.top_up, wallet.payment_processing, wallet.canteen_pos, wallet.spending_limits, wallet.transaction_history, and wallet.reconciliation in apps/api/src/SafeSchool.Api/Infrastructure/FeatureFlags/WalletCapabilities.cs
...
- [ ] T037 [P] Create unit tests for Phase 4 capability decisions including reconciliation and disabled-workflow denial in apps/api/tests/SafeSchool.Api.Tests/Features/Wallet/Foundational/WalletFeatureGateTests.cs
...
- [ ] T130 [US3] Implement CanteenCatalogService for merchant create/update, item category create/update, purchase eligibility rule create/update, status changes, duplicate code validation, tenant filters, capability enforcement, idempotency, and audit events in apps/api/src/SafeSchool.Api/Features/Wallet/Canteen/CanteenCatalogService.cs
...
- [ ] T139 [US3] Implement CanteenMerchantsController, CanteenItemCategoriesController, PurchaseEligibilityRulesController, POSTerminalsController, CanteenPurchasesController, OfflinePosSyncController, and CanteenPurchaseTraceController routes from contracts/canteen-pos-purchase.md in apps/api/src/SafeSchool.Api/Features/Wallet/Pos/CanteenPosPurchaseControllers.cs
...
- [ ] T166 [US4] Extend WalletSpendingRuleEvaluationPort baseline purchase eligibility implementation with SpendingLimitEvaluationService strictest-rule evaluation used by OnlinePurchaseAuthorizationService and OfflinePosReserveService in apps/api/src/SafeSchool.Api/Features/Wallet/Pos/WalletSpendingRuleEvaluationPort.cs
...
- [ ] T199 [US5] Implement WalletCorrectionService for refund, void, reversal, hold, release, manual adjustment, configured refund window enforcement, authorized refund window override review, original evidence lookup, amount validation, append-only ledger correction posting, closed reconciliation review item creation, idempotency, and audit events in apps/api/src/SafeSchool.Api/Features/Wallet/Corrections/WalletCorrectionService.cs
